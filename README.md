...
---
## 2025-02-25
- **Blog** **[Meta]**: [Programming languages endorsed for server-side use at Meta](https://engineering.fb.com/2022/07/27/developer-tools/programming-languages-endorsed-for-server-side-use-at-meta/)
  > Meta uses a variety of programming languages across its platforms and use cases, with **Hack, C++, Rust, and Python** being the primary supported server-side languages. **Rust** is the latest addition to this list and is recommended for performance-sensitive back-end services and CLI tools. Meta encourages the use of C++ and Rust for performance-sensitive back-end services. Hack is recommended for business logic and relatively stateless applications due to its high level of automation and support at Meta. Python remains the language of choice for data science, ML applications, and Instagram. Supporting a programming language at Meta requires a significant engineering investment, taking into account factors such as support for core libraries, security and privacy, operational risk, expertise, and developer experience. Choosing the right language is crucial for time, efficiency, and productivity.
